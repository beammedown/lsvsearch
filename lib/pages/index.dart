...
class _IndexPageState extends State<IndexPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    setState(() {
      _ergebnisse = Future.value(search(""));
    });
  }
                  ...
                  suffix: _controller.value.text != ""
                      ? AnimatedScale(
                          ...
                          child: IconButton(
                              ...
                              icon: const Icon(
                                fluent_icons.FluentIcons.delete_12_regular,
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      ComboBox(
                          ...
                          onChanged: (val) => {_comboBoxHandler(val!)},
                          placeholder: const Text("Jedes Gesetz"),
                          items: [
                            ComboBoxItem(
                                value: "all", child: Text("Jedes Gesetz")),
                            ComboBoxItem(
                                value: "VerfHe",
                                child: Text("Hessische Verfassung")),
                            ComboBoxItem(
                                value: "HSchG",
                                child: Text("Hessisches Schulgesetz")),
                            ComboBoxItem(value: "OAVO", child: Text("OAVO")),
                            ComboBoxItem(
                                value: "SV-VO", child: Text("SV-Verordnung")),
                            ComboBoxItem(value: "VOGSV", child: Text("VOGSV"))
                          ])
                    ],
                  ),
                )
                    ...
                    return Column(
                        ...
                        children: [
                          ...
                          IconButton(
                            ...
                            icon: const Icon(
                                fluent_icons.FluentIcons.sync_off_16_filled),
                          ),
                        ]);
                  } else {
                    return ProgressRing();
