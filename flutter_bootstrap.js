(() => {
  ...
  function T(n, t) {
    return n.canvasKitBaseUrl
      ? n.canvasKitBaseUrl
      : t.engineRevision && !t.useLocalCanvasKit
        ? C("https://www.gstatic.com/flutter-canvaskit", t.engineRevision)
        : "canvaskit";
  }
  var v = class {
    constructor() {
    ...
    async load(t, i, r, e, a) {
      ...
      if (t.compileTarget === "dart2wasm")
        return this._loadWasmEntrypoint(t, i, s, a);
      {
...
Read more: https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts`)),
  ...
  var b = (n, t, i, r) => (
    (window.flutterCanvasKitLoaded = (async () => {
      ...
      let c = k(l(s, "canvaskit.wasm")),
        p = await import(o);
      return (
        (window.flutterCanvasKit = await p.default({ instantiateWasm: c })),
  ...
  var U = async (n, t, i, r) => {
    let e =
        i.crossOriginIsolated && !t.forceSingleThreadedSkwasm
          ? "skwasm"
          : "skwasm_st",
      s = l(r, `${e}.js`);
  ...
  var S = class {
    ...
    async load({
      ...
      p.renderer === "canvaskit"
        ? (d.canvasKit = b(d, e, w, f))
        : p.renderer === "skwasm" && (d.skwasm = U(d, e, w, f));
      let h = new v();
      return (
        h.setTrustedTypesPolicy(d.flutterTT.policy),
        (this.didCreateEngineInitializer =
...
_flutter.buildConfig = {
  engineRevision: "871f65ac1bf129edb222c3293a636ff4b67534a6",
  builds: [
    {
...
_flutter.loader.load({
  serviceWorkerSettings: {
    serviceWorkerVersion: "1170742993",
  },
});
